						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="fenpeibianhao" name="fenpeibianhao" class="form-control" v-model="ruleForm.fenpeibianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>分配学院</label>

									<input id="fenpeixueyuan" name="fenpeixueyuan" class="form-control" v-model="ruleForm.fenpeixueyuan" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>教材名称</label>
									...
									<input id="fenpeishijian" name="fenpeishijian" class="form-control" v-model="ruleForm.fenpeishijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>数量</label>
									...
									<div class="form-group  col-md-12">
										<label>分配详情</label>
										<script id="fenpeixiangqingEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.fenpeixiangqing != null && ruleForm.fenpeixiangqing != 'null' && ruleForm.fenpeixiangqing != ''){
				var mes = '' + ruleForm.fenpeixiangqing;
				var fenpeixiangqingUeditor = UE.getEditor('fenpeixiangqingEditor');
				fenpeixiangqingUeditor.ready(function() {
					fenpeixiangqingUeditor.setContent(mes);
					fenpeixiangqingUeditor.setDisabled('fullscreen');
				});
			}
		}  
