...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>出版社管理</span></li>
								<li class="breadcrumb-item active"><span>出版社列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="chubansheSearch" class="form-control form-control-sm" placeholder="请输入出版社" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#chubansheSearch').val() != null && $('#chubansheSearch').val() != ''){
				searchForm.chubanshe ="%" +  $('#chubansheSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("chubanshe/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				chubanshe : searchForm.chubanshe,	
			},(res)=>{
				if(res.code == 0){
					clear();
