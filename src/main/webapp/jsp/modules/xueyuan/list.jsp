...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>学院列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="xueyuanSearch" class="form-control form-control-sm" placeholder="请输入学院" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xueyuanbianhao')">学院编号<i id="xueyuanbianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xueyuan')">学院<i id="xueyuanIcon" class="fa fa-sort"></i></th>
											<th>封面</th>
											<th onclick="sort('xueyuanweizhi')">学院位置<i id="xueyuanweizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xueyuanSearch').val() != null && $('#xueyuanSearch').val() != ''){
				searchForm.xueyuan ="%" +  $('#xueyuanSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var xueyuanbianhaoCell  = document.createElement('td');

						 xueyuanbianhaoCell.innerHTML = item.xueyuanbianhao;

			row.appendChild(xueyuanbianhaoCell);
			...
			var xueyuanweizhiCell  = document.createElement('td');

						 xueyuanweizhiCell.innerHTML = item.xueyuanweizhi;

			row.appendChild(xueyuanweizhiCell);
			...
			var xueyuanxiangqingCell  = document.createElement('td');
