	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">学生账号</label> 
							<input  name="xueshengzhanghao" placeholder="学生账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">学生电话</label> 
							<input  name="xueshengdianhua" placeholder="学生电话" class="form-control-i">
							</div>
