...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="xueshengzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入学生账号" aria-controls="tableId">
									<label>
										学生姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xueshengzhanghao')">学生账号<i id="xueshengzhanghaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('xueshengdianhua')">学生电话<i id="xueshengdianhuaIcon" class="fa fa-sort"></i></th>
											<th>头像</th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xueshengzhanghaoSearch').val() != null && $('#xueshengzhanghaoSearch').val() != ''){
				searchForm.xueshengzhanghao ="%" +  $('#xueshengzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xuesheng/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				xueshengzhanghao : searchForm.xueshengzhanghao,	
		...
		function setDataRow(item,number){
			...
			var xueshengzhanghaoCell  = document.createElement('td');

						 xueshengzhanghaoCell.innerHTML = item.xueshengzhanghao;

			row.appendChild(xueshengzhanghaoCell);
			...
			var xueshengdianhuaCell  = document.createElement('td');

						 xueshengdianhuaCell.innerHTML = item.xueshengdianhua;

			row.appendChild(xueshengdianhuaCell);
