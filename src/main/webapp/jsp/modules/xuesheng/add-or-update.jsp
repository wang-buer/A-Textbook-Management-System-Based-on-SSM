							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学生账号</label>
										<input name="xueshengzhanghao" id="xueshengzhanghao" name="xueshengzhanghao" class="form-control" placeholder="学生账号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>学生电话</label>
										<input name="xueshengdianhua" id="xueshengdianhua" name="xueshengdianhua" class="form-control" placeholder="学生电话">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
									...
									<div class="form-group col-md-6">
										<label>学院</label>
										<select id="xueyuanSelect" name="xueyuan" class="form-control">
										</select>	
									</div>	
	...
	<script>
		...
		function xueyuanSelect(){
			http("option/xueyuan/xueyuan","GET",{},(res)=>{
				if(res.code == 0){
					xueyuanOptions = res.data;
					var nullOption = document.createElement('option');
					var xueyuanSelect = document.getElementById('xueyuanSelect');
					xueyuanSelect.appendChild(nullOption);
					for(var i=0;i<xueyuanOptions.length;i++){
						var xueyuanOption = document.createElement('option');
						xueyuanOption.setAttribute('name','xueyuanOption');
						xueyuanOption.setAttribute('value',xueyuanOptions[i]);
						xueyuanOption.innerHTML = xueyuanOptions[i];									
						if(ruleForm.xueyuan == xueyuanOptions[i]){
							xueyuanOption.setAttribute('selected','selected');
						}
						xueyuanSelect.appendChild(xueyuanOption);
					}
				}
			});
		}	
		...
		function dataBind(){
			...
			$("#xueshengzhanghao").val(ruleForm.xueshengzhanghao);	
			...
			$("#xueshengdianhua").val(ruleForm.xueshengdianhua);	
			$("#touxiang-input").val(ruleForm.touxiang);
			var xueyuanOptions = document.getElementsByClassName("xueyuanOption");
			for(var xueyuanCount = 0; xueyuanCount < xueyuanOptions.length;xueyuanCount++){
				if(xueyuanOptions[xueyuanCount].getAttribute('value') == ruleForm.xueyuan){
					xueyuanOptions[xueyuanCount].setAttribute('selected','selected');
				}
			}
		}		
		//图片显示
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshengzhanghao != null && res.data.xueshengzhanghao != ''){
						...
						$("#xueshengzhanghao").val(res.data.xueshengzhanghao);
						$("#xueshengzhanghao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.xueshengdianhua != null && res.data.xueshengdianhua != ''){

						$("#xueshengdianhua").val(res.data.xueshengdianhua);
						$("#xueshengdianhua").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.xueyuan != null && res.data.xueyuan != ''){
						...
						var xueyuanOptions = document.getElementsByClassName("xueyuanOption");
						for(var xueyuanCount = 0; xueyuanCount < xueyuanOptions.length;xueyuanCount++){
							if(xueyuanOptions[xueyuanCount].getAttribute('value') == res.data.xueyuan){
								xueyuanOptions[xueyuanCount].setAttribute('selected','selected');
							}
						}
					}
